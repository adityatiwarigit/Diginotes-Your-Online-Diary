                ...
                if(!$name=="" && !$email == "" && !$message == "")
                {
                    ...
                    if(!$result)
                    {
                        echo "<div class='alert alert-warning alert-dismissible fade show' role='alert'>
                            <strong>Sorry</strong> Kindly fill the details again.
                    ...
                    else
                    {
                        echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                            <strong>Congrats!</strong> Our team will Contact you soon.
                            <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                        </div>";
                    }
                }
...
<head>
    ...
    <style>
        ...
        .other {
            width: 60%;
            background-image: url("../inotes/assets/logo.webp");
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../inotes/contact.php">Contact Us</a>
                    </li>
                </ul>
            </div>
        </div>
           ...
           <div class="map">
            ...
            <div class="content">
                <div class="contact">
                    <div class="other">
                        <div class="info">
                            <h2 style="color: #243342; font-weight: bolder;" >More Methods</h2>
                            <h3 style="color: #243342; font-weight: bolder;">Email</h3>
                            <div class="svg-wrap">
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" style="color: #243342; font-weight: bolder;" viewBox="0 0 485.211 485.211">
                                    ...
                                    diginotes@gmail.com</a>
                            </div>
                            <h3 style="color: #243342; font-weight: bolder;">Connect</h3>
                            <div class="svg-wrap">
                    ...
                    <div class="form">
                        <h1>Get In Touch</h1>
                        <form action="../inotes/contact.php" method="post">
                            <div class="flex-rev">
                                <input type="text" placeholder="Tom Cruiz" name="name" id="name" style="border:1px solid Grey;background-color:#EDEDED" />
                                <label for="name">Full Name</label>
                            </div>
                            <div class="flex-rev">
                                <input type="email" placeholder="xyz@gmail.com" name="email" id="email" style="border:1px solid Grey;background-color:#EDEDED"/>
                                <label for="email">Your Email</label>
                            </div>

                            <div class="flex-rev">
                                <textarea placeholder="I have an idea for a project.." name="message" id="message" style="border:1px solid Grey;background-color:#EDEDED"/></textarea>
                                <label for="message">Drop Message</label>
                            </div>
                            <button class="btn-primary"name="upload">Send Message</button>
                        </form>
                    </div>
                </div>
            </div>
